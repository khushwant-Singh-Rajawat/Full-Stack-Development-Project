...
<!-- End css3menu.com BODY section -->
    ...
    String sql="update books set book_name=?,author=?,book_subject=?,publisher=?,isbn=?,price=?,book_des=?,qty=? where bookid=?";
    ...
    book_des=request.getParameter("T7");
